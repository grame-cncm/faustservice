...
public:
    ...
    const int 	getMaxClients() 		{ return max_clients_; }		///< Max number of clients allowed to connect at a given time.
    fs::path  	getDirectory()			{ return directory_; }			///< Directory to which the uploaded files are being written.
   	fs::path  	getMakefileDirectory()	{ return makefile_directory_; } ///< Directory that the makefiles should be copied from.
    fs::path  	getLogfile()			{ return logfile_; }			///< Path to the logfile.
