...
std::string askpage_head =
    "<html><body>\n\
                       Upload a Faust file, please.<br>\n\
                       There are ";

std::string askpage_tail =
...
std::string cannotcompile =
    "<html><body>Could not execute the provided DSP program for the given architecture file.</body></html>";

std::string nosha1present = "<html><body>The given SHA1 key is not present in the directory.</body></html>";

std::string invalidosorarchitecture =
...
std::string completebutcorrupt_tail = "</body></html>";

std::string completebutalreadythere_head =
    "<html><body>The upload is completed but it looks like you have already uploaded this file.<br />Here is its SHA1 "
    "key: ";

std::string completebutalreadythere_tail = "<br />Use this key for all subsequent GET commands.</body></html>";

std::string completepage_head = "<html><body>The upload is completed.<br />Here is its SHA1 key: ";

std::string completepage_tail = "<br />Use this key for all subsequent GET commands.</body></html>";

std::string errorpage = "<html><body>This doesn't seem to be right.</body></html>";

std::string servererrorpage = "<html><body>An internal server error has occured.</body></html>";

std::string fileexistspage = "<html><body>This file already exists.</body></html>";

std::string debugstub = "<html><body>Rien ne s'est cass&eacute; la figure. F&eacute;licitations !</body></html>";
